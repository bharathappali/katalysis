<template>
  <div>
    <vs-row vs-w="12">
      <vs-col vs-type="flex" vs-justify="center" vs-align="center" vs-lg="1">
        <vs-button color="rgb(66, 185, 131)" type="filled" @click="setAllLabels()">All</vs-button>
      </vs-col>
      <vs-col vs-type="flex" vs-justify="center" vs-align="center" vs-w="2" vs-lg="2" vs-sm="2" v-if="isRunc">
        <vs-checkbox color="#42b983" v-model="chartLabels" @change="optsChanged($event)" icon="done" vs-value="runc">runc</vs-checkbox>
      </vs-col>
      <vs-col vs-type="flex" vs-justify="center" vs-align="center" vs-w="2" vs-lg="2" vs-sm="2" v-if="isKata">
        <vs-checkbox color="#42b983" v-model="chartLabels" @change="optsChanged($event)" icon="done" vs-value="kata">kata</vs-checkbox>
      </vs-col>
      <vs-col vs-type="flex" vs-justify="center" vs-align="center" vs-w="3" vs-lg="3" vs-sm="2" v-if="isKataXtune">
      ...
      <vs-col vs-type="flex" vs-justify="center" vs-align="center" vs-w="3" vs-lg="3" vs-sm="2" v-if="isKataVirtio">
      ...
      <vs-col vs-type="flex" vs-justify="center" vs-align="center" vs-w="4" vs-lg="4" vs-sm="2" v-if="isKataVirtioXtune">
      ...
      <vs-col vs-type="flex" vs-justify="center" vs-align="center" vs-w="2" vs-lg="2" vs-sm="2" v-if="isVm">
        <vs-checkbox color="#42b983" v-model="chartLabels" @change="optsChanged($event)" icon="done" vs-value="vm">VM</vs-checkbox>
      </vs-col>
      <vs-col vs-type="flex" vs-justify="center" vs-align="center" vs-w="3" vs-lg="3" vs-sm="2" v-if="isVmXtune">
