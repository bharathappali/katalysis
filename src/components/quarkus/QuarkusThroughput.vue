    ...
    <vs-row
      ...
      <vs-col vs-justify="center" vs-align="center" vs-w="5" vs-lg="5" vs-sm="12" vs-xs="12">
        <div class="links-holder" vs-w="12">
          <router-link to="/quarkus/throughput">Baseline</router-link> |
          <router-link to="/quarkus/throughput/constResources">Constant Resources</router-link> |
          <router-link to="/quarkus/throughput/virtiofs">With virtio-fs</router-link> |
          <router-link to="/quarkus/throughput/summary">Summary</router-link>
        </div>
      </vs-col>
